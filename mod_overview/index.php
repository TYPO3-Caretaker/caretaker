...
class tx_caretaker_mod_overview extends \TYPO3\CMS\Backend\Module\BaseScriptClass
{
    ...
    public function main()
    {
        ...
        if ($BE_USER->user['admin']) {
            ...
            //Add caretaker css
            $this->pageRenderer->addCssFile($BACK_PATH . \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('caretaker') . 'Resources/Public/Css/tx.caretaker.overview.css');
