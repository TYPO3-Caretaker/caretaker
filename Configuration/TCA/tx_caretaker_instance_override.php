	...
	'columns' => array(
		'type' => array(
			...
			'config' => array(
				...
				'items' => array(
					array('LLL:EXT:caretaker/locallang_db.xml:tx_caretaker_instance_override.type.test_configuration', 'test_configuration'),
					array('LLL:EXT:caretaker/locallang_db.xml:tx_caretaker_instance_override.type.curl_option', 'curl_option')
				),
