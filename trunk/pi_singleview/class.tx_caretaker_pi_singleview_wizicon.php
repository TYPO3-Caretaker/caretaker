...
class tx_caretaker_pi_singleview_wizicon {
	...
	function proc($wizardItems)	{
		...
		$wizardItems['plugins_caretaker_pi_singleview'] = array(
			'icon'=>t3lib_extMgm::extRelPath('caretaker').'pi_singleview/ce_wiz.gif',
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/user_singleview/pi1/class.user_singleview_pi1_wizicon.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/user_singleview/pi1/class.user_singleview_pi1_wizicon.php']);
}
