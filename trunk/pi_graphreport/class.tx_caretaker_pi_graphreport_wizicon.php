...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/user_graphreport/pi1/class.user_graphreport_pi1_wizicon.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/user_graphreport/pi1/class.user_graphreport_pi1_wizicon.php']);
}
