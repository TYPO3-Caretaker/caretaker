 ...
 */
class tx_caretaker_typo3_version extends t3lib_svbase implements tx_caretaker_TestService {
	var $prefixId = 'tx_caretaker_typo3_version';		// Same as class name
	var $scriptRelPath = 'sv1/class.tx_caretaker_typo3_version.php';	// Path to this script relative to the extension dir.
