...
tx.caretaker.NodeContacts = Ext.extend(Ext.grid.GridPanel, {
    ...
    constructor: function(config) {
        ...
        this.renderName = function(value, metaData, record, rowIndex, colIndex, store) {
            ...
            if (record.data.address_name) {
                full_name += record.data.address_name;
            }
            if (record.data.address_title) {
                full_name += ' ' + record.data.address_title;
            }
            if (record.data.address_first_name) {
                full_name += ' ' + record.data.address_first_name;
            }
            if (record.data.address_middle_name) {
                full_name += ' ' + record.data.address_middle_name;
            }
            if (record.data.address_last_name) {
                full_name += ' ' + record.data.address_last_name;
            }
