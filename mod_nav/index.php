...
class tx_caretaker_mod_nav extends \TYPO3\CMS\Backend\Module\BaseScriptClass
{
    ...
    public function main()
    {
        ...
        if ($BE_USER->user['admin']) {
            ...
            //Add caretaker css
            $this->pageRenderer->addCssFile(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('caretaker') . 'Resources/Public/Css/tx.caretaker.nodetree.css', 'stylesheet', 'all', '', false);
