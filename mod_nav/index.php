...
class tx_caretaker_mod_nav extends t3lib_SCbase {
	...
	function main()	{
		...
		if ($BE_USER->user["admin"]) {
			...
			$this->pageRenderer->addJsFile(t3lib_extMgm::extRelPath('caretaker') . 'res/js/tx.caretaker.js', 'text/javascript', FALSE , FALSE);
			$this->pageRenderer->addJsFile(t3lib_extMgm::extRelPath('caretaker') . 'res/js/tx.caretaker.NodeTree.js', 'text/javascript', FALSE, FALSE );

			//Add caretaker css
			$this->pageRenderer->addCssFile(t3lib_extMgm::extRelPath('caretaker') . 'res/css/tx.caretaker.nodetree.css', 'stylesheet' , 'all' , '' , FALSE);
